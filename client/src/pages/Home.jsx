...
export default function Home() {
  return (
    <div className='container'>
      <div className='row'>
        <p className='col s12 m6 home-intro'>Hi! Welcome to RetroCastleNJ!</p>
      </div>
      ...
      <div className='row no-reverse'>
        <div className='col s8 price-info'>
          ...
          items priced around $30 and occasional sales offering a 10% discount,
          you can elevate your space with nostalgic gaming charm without
          breaking the bank.
        </div>
        <div className='col s12 m6 l4'>
          <img
